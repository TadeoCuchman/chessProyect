...
function App() {
  ...
  const levelFen = {
    ...
    3: {fen: 'r1bqk2r/pppp1ppp/2n2n2/2b1p3/2BPP3/2P2N2/PP3PPP/RNBQK2R b KQkq d3 0 5', validMoves: {from:'d7', to:'d5'}},
    4: {fen: 'r1bqk2r/pppp1ppp/2n2n2/2b5/2BPP3/5N2/PP3PPP/RNBQK2R b KQkq - 0 6', validMoves: {from:'g8', to:'f6'}},
    5: {fen: 'r1bqk2r/pppp1ppp/2n2n2/8/1bBPP3/5N2/PP1B1PPP/RN1QK2R b KQkq - 2 7', validMoves: {from:'f6', to:'d5'}},
    6: {fen: 'r1bqk2r/pppp1ppp/2n2n2/8/2BPP3/5N2/PP1N1PPP/R2QK2R b KQkq - 0 8', validMoves: {from:'e8', to:'g8'}},
    7: {fen: 'r1bqk2r/ppp2ppp/2n2n2/3P4/2BP4/5N2/PP1N1PPP/R2QK2R b KQkq - 0 9', validMoves: {from:'c8', to:'e6'}}
}
